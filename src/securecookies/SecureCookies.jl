...
# Globals
cookie_max_age  = 5 * 60 * 1000        # Duration of a session's validity in milliseconds
...
timeout_str     = utf8(string(convert(Int64, 0.001 * cookie_max_age)))    # Session timeout in seconds, represented as a string
